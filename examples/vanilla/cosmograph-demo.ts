/**
 * Vanilla JS example — HyperMemory 2D graph visualization with Cosmograph.
 *
 * Prerequisites:
 *   pnpm add @hypermemory/core @hypermemory/visualizer-core @cosmograph/cosmograph
 */
...
searchInput.addEventListener("input", () => {
	viewer.search(searchInput.value);
});
