...
describe("Package exports (built artifacts)", () => {
	it("@runstack-ai/hypermemory-core exports HyperMemoryClient from built path", async () => {
	...
	it("@runstack-ai/hypermemory-core exports all error classes from built path", async () => {
		const mod = await import("../packages/core/dist/index.js");
	...
	it("@runstack-ai/hypermemory-visualizer-core exports viewers from built path", async () => {
